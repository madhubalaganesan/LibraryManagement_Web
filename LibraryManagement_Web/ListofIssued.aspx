<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListofIssued.aspx.cs" Inherits="ListofIssued" %>
...
<body background="Sonic-Free-Riders-background-art.jpg">
    <form id="form1" runat="server">
    <div class="style1">
    
        <em><strong>
        <br />
        LIST OF BOOKS ISSUED TILL DATE<br />
        <br />
        </strong></em>
    ...
    <asp:TextBox ID="TextBox1" runat="server" Visible="False">Issued</asp:TextBox>
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="False">
        <div class="style3">
            <strong><em><span class="style4">Total number of Books Issued :</span><span 
                class="style2"> </span>
